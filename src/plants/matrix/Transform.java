...
public class Transform {
	...
	/* Return a LookAt Matrix created with the three input vectors */
	...
	/* Return a Perspective matrix created with the six input parameters */
	...
	/* Return a Perspective matrix created with the four input parameters */
	...
	/* Return a rotation matrix created with the two input parameters */
	...
	/* Return a Translation matrix created with the input vector */
	...
	/* Return the result of the multiplication between the input 4x4 matrix and the input vector */
	...
	/* Transform a matrix to a float array and return it */
	public static float[] toFloatArray(Matrix4f mat) {
		int k = 0;
