...
public class Repere implements Drawable {

	private VertexShape[] vertices;
	private final static int NB_VERTICES = 6;
	private final static int DRAWING_MODE = GL3.GL_LINES;
	private int vao;
	
	public Repere(GL3 gl) {
	...
	public void draw(GL3 gl) {
		...
		gl.glDrawArrays(DRAWING_MODE, 0, NB_VERTICES);
		gl.glBindVertexArray(0);
	}
	
	private void createData() {
		this.vertices[0] = new VertexShape(0f, 0f, 0f, 1f, 0f, 0f);
		this.vertices[1] = new VertexShape(1f, 0f, 0f, 1f, 0f, 0f);
		this.vertices[2] = new VertexShape(0f, 0f, 0f, 0f, 1f, 0f);
		this.vertices[3] = new VertexShape(0f, 1f, 0f, 0f, 1f, 0f);
		this.vertices[4] = new VertexShape(0f, 0f, 0f, 0f, 0f, 1f);
		this.vertices[5] = new VertexShape(0f, 0f, 1f, 0f, 0f, 1f);
	}
	...
	private void createGLRessources(GL3 gl) {
		...
		gl.glVertexAttribPointer( Utils.REPERESHADER_POSITION_LOCATION, // attribute index
		...
		gl.glVertexAttribPointer( Utils.REPERESHADER_NORMAL_LOCATION,
	...
	private float[] getData() {
		float[] data = new float[NB_VERTICES * VertexShape.NB_TOTAL_COMPONENTS];
		int i = 0;
